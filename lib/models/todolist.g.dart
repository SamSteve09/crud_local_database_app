...
extension TodolistQueryFilter
  ...
  QueryBuilder<Todolist, Todolist, QAfterFilterCondition> deadlineEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todolist, Todolist, QAfterFilterCondition> deadlineGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todolist, Todolist, QAfterFilterCondition> deadlineLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todolist, Todolist, QAfterFilterCondition> deadlineBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Todolist, Todolist, QAfterFilterCondition> isDoneEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isDone',
...
extension TodolistQuerySortBy on QueryBuilder<Todolist, Todolist, QSortBy> {
  QueryBuilder<Todolist, Todolist, QAfterSortBy> sortByDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.asc);
    });
  }

  QueryBuilder<Todolist, Todolist, QAfterSortBy> sortByDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.desc);
    });
  }

  QueryBuilder<Todolist, Todolist, QAfterSortBy> sortByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<Todolist, Todolist, QAfterSortBy> sortByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodolistQuerySortThenBy
  ...
  QueryBuilder<Todolist, Todolist, QAfterSortBy> thenByDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.asc);
    });
  }

  QueryBuilder<Todolist, Todolist, QAfterSortBy> thenByDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.desc);
    });
  }
  ...
  QueryBuilder<Todolist, Todolist, QAfterSortBy> thenByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<Todolist, Todolist, QAfterSortBy> thenByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.desc);
    });
  }
...
extension TodolistQueryWhereDistinct
  ...
  QueryBuilder<Todolist, Todolist, QDistinct> distinctByDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'deadline');
    });
  }

  QueryBuilder<Todolist, Todolist, QDistinct> distinctByIsDone() {
    return QueryBuilder.apply(this, (query) {
...
extension TodolistQueryProperty
  ...
  QueryBuilder<Todolist, DateTime, QQueryOperations> deadlineProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'deadline');
    });
  }

  QueryBuilder<Todolist, bool, QQueryOperations> isDoneProperty() {
    return QueryBuilder.apply(this, (query) {
